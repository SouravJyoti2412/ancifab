(function($) {
    ...
    $("#id_discount").change(function() {
        if(this.checked) {
            $('#id_price').attr('disabled',false);
        }
        else{
            $('#id_price').attr('disabled',true);
            $("#error_price").text("");
            $('#id_price').css("border-color", "#808080");
        }
    });
    $("#id_price").focusout(function(){
            
        $pass =$("#id_discount_price").val();
        $cpass =$("#id_price").val();
        // if($(this).val()==''){
        //     $(this).css("border-color", "#FF0000");
        //         $('#finish').attr('disabled',true);
        //         $("#error_price").text("* enter discount price");
        // }
         if ($pass <= $cpass  )
        {   
            $(this).css("border-color", "#FF0000");
            $('#finish').attr('disabled',true);
            $("#error_price").text("* discount price should be less than price");
        }
        else{
